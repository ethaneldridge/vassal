 ...
 * To make a Buildable component, extend this class.  You'll need to
...
public abstract class AbstractBuildable implements Buildable, ValidityChecker {
   ...
   * element and calling {@link #setAttribute} with the  String value
   * of the attribute
   */
   ...
   * If the <code>value</code> parameter is a String, it will be the
   * value returned by {@link #getAttributeValueString} for the same
   * <code>key</code>.  If the implementing class extends
   * {@link AbstractConfigurable}, then <code>value</code> will be
   * an instance of the corresponding Class listed in
   * {@link AbstractConfigurable#getAttributeTypes}
   *
   * @param key the name of the attribute.  Will be one of those
   * listed in {@link #getAttributeNames}
   */
  ...
  /**
   * Returns an enumeration of Buildable objects which are the
   * direct children of this object in the Buildable containment hierarchy.
   * The {@link #getBuildElement} method uses these objects to construct
