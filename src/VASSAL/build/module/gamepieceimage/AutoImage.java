...
public class AutoImage extends Decorator  implements EditablePiece {
  ...
  protected GamePieceLayout layout = null;
  protected GamePieceImage defn = null;
  ...
  protected void buildImage() {
     ...
     */
    //if (defn == null) {
      defn = (GamePieceImage) (GamePieceImageDefinitions.getInstance().getGenericDefn(definitionName));
      if (defn == null) {
        return;
      }
      defn = (GamePieceImage) defn.clone();
      reBuildImage();
  }
