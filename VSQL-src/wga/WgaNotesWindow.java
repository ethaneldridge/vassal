 ...
 * him
 */
public class WgaNotesWindow extends AbstractConfigurable
  ...
  public static class IconConfig implements ConfigurerFactory {
    public Configurer getConfigurer(AutoConfigurable c, String key, String name) {
      return new IconConfigurer(key, name, ((WgaNotesWindow) c).launch.getAttributeValueString(ICON));
    }
  }
