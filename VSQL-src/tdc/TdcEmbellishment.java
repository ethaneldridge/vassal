 ...
 */
public class TdcEmbellishment extends Decorator implements EditablePiece {
  ...
  public TdcEmbellishment() {
    this(ID + "Activate", null);
  }

  public TdcEmbellishment(String type, GamePiece d) {
    mySetType(type);
    setInner(d);
  }
   ...
   */
  public static TdcEmbellishment getLayerWithMatchingActivateCommand(GamePiece piece, KeyStroke stroke, boolean active) {
    for (TdcEmbellishment layer = (TdcEmbellishment) Decorator.getDecorator(piece, TdcEmbellishment.class);
         layer != null;
         layer = (TdcEmbellishment) Decorator.getDecorator(layer.piece, TdcEmbellishment.class)) {
  ...
  private static class Ed implements PieceEditor {
    ...
    public void reset(TdcEmbellishment e) {
      name.setText(e.name);
      names = new Vector();
      isPrefix = new Vector();
