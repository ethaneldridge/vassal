...
public class PlcLabeler extends Decorator implements EditablePiece {
  public static final String ID = "plclabel;";
  ...
  public PlcLabeler(String s, GamePiece d) {
    lbl = new JLabel();
    mySetType(s);
    setInner(d);
  }
