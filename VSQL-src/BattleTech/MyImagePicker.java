...
public class MyImagePicker extends javax.swing.JPanel implements MouseListener, ItemListener {
...
/*  private Image getImage() throws java.io.IOException {
  ...
  public Image getImage() throws java.io.IOException 
  {
	  ...
	  {
		  Image temp = Toolkit.getDefaultToolkit().getImage ( getImagepath() );
		  return temp;
	  }
  }
  ...
  public void pickImage() 
  {
	  ...
	  if (fc.showOpenDialog(null) == javax.swing.JFileChooser.APPROVE_OPTION && fc.getSelectedFile().exists()) 
	  {
