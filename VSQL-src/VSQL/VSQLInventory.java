...
public class VSQLInventory extends AbstractConfigurable implements GameComponent {
  ...
  public static final String NON_LEAF_LOW_FORMAT = "nonLeafLowFormat";
  protected String nonLeafLowFormat = "$PropertyValue$";
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {"Name", "Button text", "Button icon", "Hotkey", "Tooltip", "Show only pieces matching these properties", "Sort and Group By Properties",
        "Label for folders", "Label for lowest level folders", 
        "Show only folders", "Label for pieces", "Center on selected piece", "Forward key strokes to selected piece",
        "Show right-click menu of piece", "Draw piece images", "Zoom factor", "Available to these sides"};
  }

  public Class[] getAttributeTypes() {
    return new Class[] {String.class, String.class, IconConfig.class, KeyStroke.class, String.class, String.class, String[].class, String.class, 
        String.class, Boolean.class,
        PieceFormatConfig.class, Boolean.class, Boolean.class, Boolean.class, Boolean.class, Double.class, String[].class};
  }

  public String[] getAttributeNames() {
    return new String[] {NAME, BUTTON_TEXT, ICON, HOTKEY, TOOLTIP, FILTER, GROUP_BY, NON_LEAF_FORMAT, NON_LEAF_LOW_FORMAT, FOLDERS_ONLY, LEAF_FORMAT, CENTERONPIECE,
  ...
  public void setAttribute(String key, Object o) {
    ...
    else if (NON_LEAF_LOW_FORMAT.equals(key)) {
      nonLeafLowFormat = (String) o;
    }
  ...
  public class Counter implements PropertySource {
    ...
    protected FormattedString childlessFormat;
    protected CounterNode node;

    public Counter(String name) {
      this(null, null, 0, nonLeafFormat, nonLeafLowFormat);
      this.localName = name;
    }

    public Counter(GamePiece piece, ArrayList groups, int value, String format) {
      this(piece, groups, value, format, "");
    }
    
    public Counter(GamePiece piece, ArrayList groups, int value, String format, String childlessFormat) {
      this.piece = piece;
      this.value = value;
      this.groups = groups;
      this.format = new FormattedString(format);
      this.childlessFormat = new FormattedString(childlessFormat);
    }
    ...
    public Object getProperty(Object key) {
      ...
      if (s.startsWith("sum_")) {
        ...
        if (piece != null) {
          ...
          value = String.valueOf(results.getChildCount(node));
        }
      }
  ...
  public class CounterNode {
    ...
    // Are all my children leaves?
    public boolean isLeafParent() {
      return !isLeaf() && ((CounterNode) children.get(0)).isLeaf();
    }
