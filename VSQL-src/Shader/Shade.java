 ...
 */
public class Shade extends AbstractConfigurable implements ActionListener {
  ...
  public static final String RANGE_PROMPT = "rangePrompt";
  ...
  protected String defaultRangePrompt = "Default Range";
  protected boolean configuringDefaultRange = false;
  ...
  public String getDefaultRangePrompt() {
    return defaultRangePrompt;
  }
  ...
  public void actionPerformed(ActionEvent arg0) {
    configuringDefaultRange = true;
    new ConfigurerWindow(getConfigurer()).setVisible(true);
    configuringDefaultRange = false;
    setDirty(true);
    shader.getMap().repaint();
  }
  ...
  public void setAttribute(String key, Object value) {
    ...
    else if (RANGE_PROMPT.equals(key)) {
      defaultRangePrompt = (String) value;
    }
  ...
  public VisibilityCondition getAttributeVisibility(String name) {
   if (configuringDefaultRange && !RANGE.equals(name)) {
   ...
   else if (RANGE_PROMPT.equals(name)) {
     return new VisibilityCondition() {
       public boolean shouldBeVisible() {
         return isVariableDefaultRange();
       }
     };
   }
    else {
  ...
  public void addTo(Buildable parent) {
    shader = (MapShader) parent; 
    shader.addShade(this);
  }
