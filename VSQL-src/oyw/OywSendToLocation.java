 ...
 */
public class OywSendToLocation extends Decorator implements EditablePiece {
  ...
  public OywSendToLocation() {
    this(ID + ";;;;0;0;;", null);
  }

  public OywSendToLocation(String type, GamePiece inner) {
    mySetType(type);
    setInner(inner);
  }
